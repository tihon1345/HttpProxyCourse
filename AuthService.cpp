...
static const QString ADMIN_HASH = "240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9";
...
bool AuthService::checkAdminPassword(const QString& password) {
    ...
    return (QString::compare(inputHash, ADMIN_HASH, Qt::CaseInsensitive) == 0);
}
